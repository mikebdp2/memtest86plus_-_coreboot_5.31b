...
int mt86_strstr(const char *str1, const char *str2);
...
#define MAX_MEM_PAGES_SEGMENTS E820MAX
...
struct vars {
	...
	struct pmap pmap[MAX_MEM_PAGES_SEGMENTS];
	volatile struct mmap map[MAX_MEM_PAGES_SEGMENTS];
	ulong plim_lower;
	ulong plim_upper;
	ulong clks_msec;
	ulong starth;
